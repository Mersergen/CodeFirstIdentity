...
namespace MVCWithDB_Identity.Areas.Identity.Pages.Account
{
	[AllowAnonymous]
	public class RegisterModel : PageModel
	{
		...
		public async Task<IActionResult> OnPostAsync(string returnUrl = null)
		{
			...
			if (ModelState.IsValid)
			{
				...
				bool roleExist = await _roleManager.RoleExistsAsync(Input.Role);

				if (!roleExist)
				{
					roleResult = await _roleManager.CreateAsync(new IdentityRole(Input.Role));
				}
